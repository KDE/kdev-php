...
K_EXPORT_PLUGIN(KDevPhpSupportFactory(KAboutData("kdevphpsupport","kdevphp", ki18n("Php Support"), "1.0 RC 2", ki18n("Support for Php Language"), KAboutData::License_GPL)
