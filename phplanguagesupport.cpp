...
K_EXPORT_PLUGIN(KDevPhpSupportFactory(KAboutData("kdevphpsupport","kdevphp", ki18n("Php Support"), "1.2.82", ki18n("Support for Php Language"), KAboutData::License_GPL)
