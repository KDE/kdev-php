...
K_EXPORT_PLUGIN(KDevPhpSupportFactory(KAboutData("kdevphpsupport","kdevphp", ki18n("Php Support"), "1.0 Beta 4", ki18n("Support for Php Language"), KAboutData::License_GPL)
