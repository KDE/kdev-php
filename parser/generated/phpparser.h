...
// memory pool
    ...
    enum TokenType
    {
        ...
        Token_BIT_OR = 1009,
        Token_BIT_XOR = 1010,
        Token_BOOLEAN_AND = 1011,
        Token_BOOLEAN_OR = 1012,
        Token_BOOL_CAST = 1013,
        Token_BREAK = 1014,
        Token_CASE = 1015,
        Token_CATCH = 1016,
        Token_CLASS = 1017,
        Token_CLASS_C = 1018,
        Token_CLONE = 1019,
        Token_CLOSE_TAG = 1020,
        Token_COLON = 1021,
        Token_COMMA = 1022,
        Token_COMMENT = 1023,
        Token_CONCAT = 1024,
        Token_CONCAT_EQUAL = 1025,
        Token_CONST = 1026,
        Token_CONSTANT_ENCAPSED_STRING = 1027,
        Token_CONTINUE = 1028,
        Token_CURLY_OPEN = 1029,
        Token_DEC = 1030,
        Token_DECLARE = 1031,
        Token_DEFAULT = 1032,
        Token_DIV = 1033,
        Token_DIV_EQUAL = 1034,
        Token_DNUMBER = 1035,
        Token_DO = 1036,
        Token_DOC_COMMENT = 1037,
        Token_DOLLAR = 1038,
        Token_DOLLAR_OPEN_CURLY_BRACES = 1039,
        Token_DOUBLE_ARROW = 1040,
        Token_DOUBLE_CAST = 1041,
        Token_DOUBLE_QUOTE = 1042,
        Token_ECHO = 1043,
        Token_ELSE = 1044,
        Token_ELSEIF = 1045,
        Token_EMPTY = 1046,
        Token_ENCAPSED_AND_WHITESPACE = 1047,
        Token_ENDDECLARE = 1048,
        Token_ENDFOR = 1049,
        Token_ENDFOREACH = 1050,
        Token_ENDIF = 1051,
        Token_ENDSWITCH = 1052,
        Token_ENDWHILE = 1053,
        Token_END_HEREDOC = 1054,
        Token_EOF = 1055,
        Token_EQUAL = 1056,
        Token_EVAL = 1057,
        Token_EXIT = 1058,
        ...
        Token_METHOD_C = 1096,
        Token_MINUS = 1097,
        Token_MINUS_EQUAL = 1098,
        Token_MOD = 1099,
        Token_MOD_EQUAL = 1100,
        Token_MUL = 1101,
        Token_MUL_EQUAL = 1102,
        Token_NEW = 1103,
