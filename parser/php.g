...
-> classBody ;;
  ...
  | USE #identifier=namespacedIdentifier @ COMMA (traitAliasDeclaration|SEMICOLON)
-> classStatement ;;
...
-> traitAliasDeclaration ;;
    ...
    traitAliasIdentifier (AS aliasIdentifier=identifier|INSTEADOF conflictIdentifier=namespacedIdentifier)
-> traitAliasStatement ;;
